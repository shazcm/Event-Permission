...
urlpatterns = [
    ...
    path('principal/reject-approved/<int:event_id>/',
         views.principal_reject_approved_event,
         name='principal_reject_approved_event'),
    ...
    path('faculty/approved/',
        views.faculty_approved_events,
        name='faculty_approved_events'),
    path('faculty/upload-post-event-data/',
        views.faculty_upload_post_event_data,
        name='faculty_upload_post_event_data'),
    path('faculty/post-submissions/',
        views.faculty_post_submission_due_events,
        name='faculty_post_submission_due_events'),
    path('faculty/rejected/',
        views.faculty_rejected_events,
        name='faculty_rejected_events'),
    path('faculty/rejected/<int:event_id>/edit-resubmit/',
        views.faculty_edit_resubmit_event,
        name='faculty_edit_resubmit_event'),
